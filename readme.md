...
* [TLS Socket - Client and Server example](https://github.com/nareix/tls-example)
* [Network Programming With Go - Jan Newmarch](https://jannewmarch.gitbooks.io/network-programming-with-go-golang-/content/index.html)
  * [WebSockets over TLS](https://jannewmarch.gitbooks.io/network-programming-with-go-golang-/content/web_sockets_over_tls.html)
